...
(function() {
  var Babel, Babel_es2015, CHUNK_CODE, CSS_REG, Chok, Dict, EMap, ENV, FS, FSE, Indexer, JMin, JS_REG, MULTI_COMMENT_MAP, NODE_MODULES, PACK_CODE, Packer, Path, SINGLE_COMMENT_MAP, getChunkCode, getPackCode,
  ...
  Packer = (function() {
    ...
    Packer.prototype.completed = function() {
      ...
      d = new Date();
      console.log("packer ready " + (this.errors.length ? 'with errors ' : '✓') + " " + this.cfg.bundles[0].out + " - " + (d.getHours()) + ":" + (d.getMinutes()) + ":" + (d.getSeconds()) + " " + (d.getFullYear()) + "." + (d.getMonth()) + "." + (d.getDate()));
      return null;
    };
